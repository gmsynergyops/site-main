...
export const doctors: Doctor[] = [
  ...
  },
  {
    id: 25,
    name: "Dr. A. Mishra",
    qualification: "M.B.B.S, MS, MCH, Surgical Oncologist",
    department: "Surgical Oncology",
    experience: "5+ years",
    image: "/doctors/fallback-male-doctor.png",
    availability: [
  ...
  },
  {
    id: 26,
    name: "Dr. Afreen Ali",
    qualification: "FNB (Minimal Access Surgery & Oncosurgery), MS (General Surgery), MBBS, FIAGES, FALS (Hernia), MCLS, Training in Abdominal Wall Reconstruction & Anal Sphincter Repair",
    department: "Gastroenterology",
    experience: "9+ years",
